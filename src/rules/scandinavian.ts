...
export const SCANDINAVIAN_YATZY: IRuleSet = {
  ...
  categories: [
    ...
    { id: ECategory.SmallStraight, label: "Small Straight", section: ESection.Lower, validValues: [15], dice: [[1, 2, 3, 4, 5]] },
    { id: ECategory.LargeStraight, label: "Large Straight", section: ESection.Lower, validValues: [20], dice: [[2, 3, 4, 5, 6]] },
