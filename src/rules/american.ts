...
/** Official US Yahtzee scoring, minus the extra-Yahtzee bonus and joker rules. */
export const AMERICAN_YATZY: IRuleSet = {
  id: "american",
  name: "American Yatzy",
  bonus: { threshold: 63, amount: 35 },
  categories: [
    ...
    // Three and Four of a Kind score the sum of all five dice, not just the matching ones.
    { id: ECategory.ThreeOfAKind, label: "Three of a Kind", section: ESection.Lower, validValues: range(5, 30), dice: [[6, 6, 6, "?", "?"]] },
    { id: ECategory.FourOfAKind, label: "Four of a Kind", section: ESection.Lower, validValues: range(5, 30), dice: [[6, 6, 6, 6, "?"]] },
    { id: ECategory.FullHouse, label: "Full House", section: ESection.Lower, validValues: [25], dice: [[5, 5, 5], [6, 6]] },
